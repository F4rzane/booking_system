...
#[ResponseType(response: ['facility' => FacilityDTO::class], description: 'create new facility')]
class CreateFacilityAction extends AbstractCreateAction
{
    protected string $resourceName = 'facility';
    ...
    protected function createResource(): BaseDTO|FacilityDTO
    {
